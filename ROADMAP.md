...
- [x] **Day 28:** **OWASP LLM03 (Training Data Poisoning):** Create a hashing gate to audit data ingest streams against dirty datasets.
- [x] **Day 29:** **OWASP LLM04 (Model Denial of Service):** Configure an active token bucket rate-shaper to prevent thread-exhaustion.
